    ...
    <section id="skills" className="section-shell">
      <Container>
        <SectionHeading
          ...
          lead="My strongest work brings frontend technologies, maintainable systems, dependable tooling, and accessibility together."
        />
          ...
          {skillGroups.map((group, index) => (
            <Reveal key={group.title} delay={index * 80}>
              <PaperCard className="h-full">
                <Tape side={index === 1 ? 'left' : 'right'} className={index === 1 ? 'w-20' : 'w-16'} />
